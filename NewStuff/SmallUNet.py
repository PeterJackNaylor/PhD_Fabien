...
CUDA_NODE = 0
SAVE_DIR = "/share/data40T_v2/Peter/tmp/SmallUNet/LONG_With_1"
N_ITER_MAX = 200000
N_TRAIN_SAVE = 10
N_TEST_SAVE = 20
LEARNING_RATE = 1.
...
def UNetModel(Input, PhaseTrain, ImageSizeIn, ImageSizeOut, KeepProbability):
    ...
    Out2_1 = PTF.ConvBatchLayer(MaxPool1, 8, 16, ks, "Conv2_1", padding, PhaseTrain, S)
    Out2_2 = PTF.ConvBatchLayer(Out2_1, 16, 16, ks, "Conv2_2", padding, PhaseTrain, S)
    ImageSize2_2 = ImageSize1_2 / 2 - 4
    MaxPool2 = tf.nn.max_pool(Out2_2, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID", name="Maxpool2")

    Out3_1 = PTF.ConvBatchLayer(MaxPool2, 16, 32, ks, "Conv3_1", padding, PhaseTrain, S)
    Out3_2 = PTF.ConvBatchLayer(Out3_1, 32, 32, ks, "Conv3_2", padding, PhaseTrain, S)
    ImageSize3_2 = ImageSize2_2 / 2 - 4
    MaxPool3 = tf.nn.max_pool(Out3_2, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID", name="Maxpool3")

    Out4_1 = PTF.ConvBatchLayer(MaxPool3, 32, 64, ks, "Conv4_1", padding, PhaseTrain, S)
    Out4_2 = PTF.ConvBatchLayer(Out4_1, 64, 64, ks, "Conv4_2", padding, PhaseTrain, S)
    ImageSize4_2 = ImageSize3_2 / 2 - 4
    MaxPool4 = tf.nn.max_pool(Out4_2, ksize=[1, 2, 2, 1], strides=[1, 2, 2, 1], padding="VALID", name="Maxpool4")

    Out5_1 = PTF.ConvBatchLayer(MaxPool4, 64, 128, ks, "Conv5_1", padding, PhaseTrain, S)
    Out5_2 = PTF.ConvBatchLayer(Out5_1, 128, 128, ks, "Conv5_2", padding, PhaseTrain, S)
    ImageSizeTransposeConv4 = (ImageSize4_2 / 2 - 4) * 2
    TranCon4 = PTF.TransposeConvLayer(Out5_2, 128, 64, 2, "TransposeConv4", padding, PhaseTrain, S)

    #### 
    Concat4 = PTF.CropAndMerge(Out4_2, TranCon4, ImageSize4_2, ImageSizeTransposeConv4, "Concat4") # Concat has 1024 features maps
    Out4_3 = PTF.ConvBatchLayer(Concat4, 128, 64, ks, "Conv4_3", padding, PhaseTrain, S)
    Out4_4 = PTF.ConvBatchLayer(Out4_3, 64, 64, ks, "Conv4_4", padding, PhaseTrain, S)
    ImageSizeTransposeConv3 = (ImageSizeTransposeConv4 - 4) * 2
    TranCon3 = PTF.TransposeConvLayer(Out4_4, 64, 32, 2, "TransposeConv3", padding, PhaseTrain, S)

    ####
    Concat3 = PTF.CropAndMerge(Out3_2, TranCon3, ImageSize3_2, ImageSizeTransposeConv3, "Concat3") # Concat has 512 features maps
    Out3_3 = PTF.ConvBatchLayer(Concat3, 64, 32, ks, "Conv3_3", padding, PhaseTrain, S)
    Out3_4 = PTF.ConvBatchLayer(Out3_3, 32, 32, ks, "Conv3_4", padding, PhaseTrain, S)
    ImageSizeTransposeConv2 = (ImageSizeTransposeConv3 - 4) * 2
    TranCon2 = PTF.TransposeConvLayer(Out3_4, 32, 16, 2, "TransposeConv2", padding, PhaseTrain, S)

    ####
    Concat2 = PTF.CropAndMerge(Out2_2, TranCon2, ImageSize2_2, ImageSizeTransposeConv2, "Concat2") # Concat has 256 features maps
    Out2_3 = PTF.ConvBatchLayer(Concat2, 32, 16, ks, "Conv2_3", padding, PhaseTrain, S)
    Out2_4 = PTF.ConvBatchLayer(Out2_3, 16, 16, ks, "Conv2_4", padding, PhaseTrain, S)
    ImageSizeTransposeConv1 = (ImageSizeTransposeConv2 - 4) * 2
    TranCon1 = PTF.TransposeConvLayer(Out2_4, 16, 8, 2, "TransposeConv1", padding, PhaseTrain, S)

    ####
    Concat1 = PTF.CropAndMerge(Out1_2, TranCon1, ImageSize1_2, ImageSizeTransposeConv1, "Concat2") # Concat has 128 features maps
    Out1_3 = PTF.ConvBatchLayer(Concat1, 16, 8, ks, "Conv1_3", padding, PhaseTrain, S)
    Out1_4 = PTF.ConvBatchLayer(Out1_3, 8, 8, ks, "Conv1_4", padding, PhaseTrain, S)

    logits = PTF.ConvBatchLayerWithoutRelu(Out1_4, 8, 2, 1, "BeforeLoss", padding, PhaseTrain, S)
