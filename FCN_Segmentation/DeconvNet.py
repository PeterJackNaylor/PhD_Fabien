...
def DeconvNet(split, data_gene, classifier_name="DeconvNet"):
    ...
    n.pool2, n.pool2_mask = max_pool(n.relu2_2, ks = 2, stride = 2)
    ...
    n.pool4, n.pool4_mask = max_pool(n.relu4_3, ks = 2, stride = 2)
    ...
    n.deconv_fc6, n.deconv_fc6_bn, n.deconv_fc6_relu = DeconvBnRelu(n.drop7, 512, ks = 7)

    n.unpool5 = max_unpool(n.deconv_fc6_relu, n.pool5_mask, unpool_size = 14)

    n.deconv5_1, n.debn5_1, n.derelu5_1 = DeconvBnRelu(n.unpool5, 512, ks = 3, pad = 1)
    n.deconv5_2, n.debn5_2, n.derelu5_2 = DeconvBnRelu(n.derelu5_1, 512, ks = 3, pad = 1)
    n.deconv5_3, n.debn5_3, n.derelu5_3 = DeconvBnRelu(n.derelu5_2, 512, ks = 3, pad = 1)

    n.unpool4 = max_unpool(n.derelu5_3, n.pool4_mask, unpool_size = 28)

    n.deconv4_1, n.debn4_1, n.derelu4_1 = DeconvBnRelu(n.unpool4, 512, ks = 3, pad = 1)
    n.deconv4_2, n.debn4_2, n.derelu4_2 = DeconvBnRelu(n.derelu4_1, 512, ks = 3, pad = 1)
    n.deconv4_3, n.debn4_3, n.derelu4_3 = DeconvBnRelu(n.derelu4_2, 256, ks = 3, pad = 1)

    n.unpool3 = max_unpool(n.derelu4_3, n.pool3_mask, unpool_size = 56)

    n.deconv3_1, n.debn3_1, n.derelu3_1 = DeconvBnRelu(n.unpool3, 256, ks = 3, pad = 1)
    n.deconv3_2, n.debn3_2, n.derelu3_2 = DeconvBnRelu(n.derelu3_1, 256, ks = 3, pad = 1)
    n.deconv3_3, n.debn3_3, n.derelu3_3 = DeconvBnRelu(n.derelu3_2, 128, ks = 3, pad = 1)    

    n.unpool2 = max_unpool(n.derelu3_3, n.pool2_mask, unpool_size = 112)

    n.deconv2_1, n.debn2_1, n.derelu2_1 = DeconvBnRelu(n.unpool2, 128, ks = 3, pad = 1)
    n.deconv2_2, n.debn2_2, n.derelu2_2 = DeconvBnRelu(n.derelu2_1, 64, ks = 3, pad = 1)

    n.unpool1 = max_unpool(n.derelu2_2, n.pool1_mask, unpool_size = 224)

    n.deconv1_1, n.debn1_1, n.derelu1_1 = DeconvBnRelu(n.unpool1, 64, ks = 3, pad = 1)
    n.deconv1_2, n.debn1_2, n.derelu1_2 = DeconvBnRelu(n.derelu1_1, 64, ks = 3, pad = 1)

    n.seg_score = Conv(n.derelu1_2, 2 , ks = 1, stride=1, pad=1)
	n.seg_score = L.Convolution(n.derelu1_2, kernel_size=ks, stride=1,
                        num_output=2, pad=1,
                        param=[dict(lr_mult=1, decay_mult=1), dict(lr_mult=2, decay_mult=0)],
                        weight_filler=Gaussian_fil,
                        bias_filler=Constant_fil)
	if split != "val":
		n.loss = L.SoftmaxWithLoss(n.seg_score, n.label,
