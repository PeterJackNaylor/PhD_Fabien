...
if __name__ == '__main__':
    ...
    log_folder = options.log + "/log__fcn32__{}".format(options.lr)
    ...
    # annotation = tf.squeeze(tf.cast(annotation, tf.int32), squeeze_dims=[3])
    ...
    init_fn = slim.assign_from_checkpoint_fn(model_path=checkpoint_path,
